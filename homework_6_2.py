class Vehicle:
    __COLOR_VARIANTS = ['blue', 'yellow', 'green', 'purple', 'white']
    ...
    def set_color(self, new_color):
        if new_color.lower() in Vehicle.__COLOR_VARIANTS:
            ...
            print(f"Новый цвет авто: {new_color.lower()}")
        else:
...
# Текущие цвета __COLOR_VARIANTS = ['blue', 'yellow', 'green', 'purple', 'white']
vehicle1 = Vehicle('Fedos', 'Toyota Mark II', 500, 'white')
